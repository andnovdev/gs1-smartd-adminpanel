...
<div class="site-section">
    <div class="container">
        <div class="row">
            <div class="col-md-6">
                <img src="{{asset('lib/images/img_1.jpg')}}" alt="Image" class="img-fluid">
            </div>
        ...
        <div class="row align-items-stretch">
            ...
            <div class="col-lg-4 col-md-6 mb-5">
                <div class="post-entry-1 h-100 person-1 teal">
                    ...
                    <img src="{{asset('lib/images/person_1.jpg')}}" alt="Image" class="img-fluid">
            ...
            <div class="col-lg-4 col-md-6 mb-5">
                <div class="post-entry-1 h-100 person-1 yellow">
                    ...
                    <img src="{{asset('lib/images/person_2.jpg')}}" alt="Image" class="img-fluid">
            ...
            <div class="col-lg-4 col-md-6 mb-5">
                <div class="post-entry-1 h-100 person-1 red">
                    ...
                    <img src="{{asset('lib/images/person_3.jpg')}}" alt="Image" class="img-fluid">
            ...
            <div class="col-lg-4 col-md-6 mb-5">
                <div class="post-entry-1 h-100 person-1 green">
                    ...
                    <img src="{{asset('lib/images/person_4.jpg')}}" alt="Image" class="img-fluid">
            ...
            <div class="col-lg-4 col-md-6 mb-5">
                <div class="post-entry-1 h-100 person-1 blue">
                    ...
                    <img src="{{asset('lib/images/person_5.jpg')}}" alt="Image" class="img-fluid">
        ...
        <div class="row">
            <div class="col-lg-4">
                <div class="package text-center bg-white">
                    <span class="img-wrap"><img src="{{asset('lib/images/flaticon/svg/001-jigsaw.svg')}}" alt="Image"
            ...
            <div class="col-lg-4">
                <div class="package text-center bg-white">
                    <span class="img-wrap"><img src="{{asset('lib/images/flaticon/svg/002-target.svg')}}" alt="Image"
                            class="img-fluid"></span>
            ...
            <div class="col-lg-4">
                <div class="package text-center bg-white">
                    <span class="img-wrap"><img src="{{asset('lib/images/flaticon/svg/003-mission.svg')}}" alt="Image"
                            class="img-fluid"></span>
